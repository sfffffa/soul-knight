...

{
	...
	//
	auto hunter = Sprite::createWithSpriteFrameName("猎人npc.png"); 
	auto oldMan = Sprite::createWithSpriteFrameName("老头npc.png");
	...
	//
	auto hero = Sprite::createWithSpriteFrameName("hero1.png");//待处理
	//this->addHero(hero,Vec2(,));
